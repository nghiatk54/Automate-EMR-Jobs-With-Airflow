...
import boto3
from airflow.providers.amazon.aws.operator.emr import (
...
# Dictionary configure EMR cluster
job_flow_overrides = {
...
with DAG('redfin_analytics_spark_job_dag',
         ...
         catchup = False) as dag:
           ...
           # Extract data step in EMR Cluster
